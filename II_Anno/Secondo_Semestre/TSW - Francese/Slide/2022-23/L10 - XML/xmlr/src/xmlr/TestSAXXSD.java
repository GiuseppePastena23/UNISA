...
public class TestSAXXSD extends DefaultHandler {
	...
	public static void main(String args[]) throws Exception {
		...
		try {
			...
			ContentHandler handler = new TestSAXXSD();
			xmlReader.setContentHandler(handler);
			xmlReader.parse("/Users/michelerisi/Documents/workspacetsw/xmlr/provasaxxsd.xml");
		} catch (Exception e) {
