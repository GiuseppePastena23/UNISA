...
public class Atm extends Banca {
    ...
    private static final String SALDO_CONTO_CORRENTE = "Saldo Conto Corrente: €";
    private static final String SALDO_CONTO_RISPARMIO = "Saldo Conto Risparmio: €";
    ...
    private void displayChoice(String input) {
        try {
            ...
            if( i == 0 ){
                ...
                this.display = String.format("%s%8.2f\n\n%s",
                        SALDO_CONTO_CORRENTE,this.selectedCliente.getSaldoContoCorrente(), SELEZIONA_OPERAZIONE);
            } else if ( i == 2 ) {
                this.display = String.format("%s%8.2f\n\n%s",
                        SALDO_CONTO_RISPARMIO,this.selectedCliente.getSaldoContoRisparmio(), SELEZIONA_OPERAZIONE);
            } else if ( i == 3 ) {
                this.versamento = true;
                this.selectedConto = this.selectedCliente.contoCorrente;
                this.display = String.format("%s", VERSAMENTO_CC);
            } else if ( i == 4 ) {
                this.versamento = true;
                this.selectedConto = this.selectedCliente.contoRisparmio;
