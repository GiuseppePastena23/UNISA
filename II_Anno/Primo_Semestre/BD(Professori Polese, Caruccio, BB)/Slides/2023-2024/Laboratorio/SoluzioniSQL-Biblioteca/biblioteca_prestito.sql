...
CREATE TABLE `prestito` (
  ...
  KEY `copia_idx` (`codiceCatalogazione`),
  CONSTRAINT `copia` FOREIGN KEY (`codiceCatalogazione`) REFERENCES `copia` (`codiceCatalogazione`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `socio` FOREIGN KEY (`matricola`) REFERENCES `socio` (`matricola`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `prestito` VALUES ('01',2,'2023-12-11',NULL,20);
