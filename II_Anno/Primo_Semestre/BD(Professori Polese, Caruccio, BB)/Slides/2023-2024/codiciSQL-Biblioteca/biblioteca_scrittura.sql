...
CREATE TABLE `scrittura` (
  ...
  KEY `codiceAutore_idx` (`codiceAutore`),
  CONSTRAINT `codiceAutore` FOREIGN KEY (`codiceAutore`) REFERENCES `autore` (`codice`),
  CONSTRAINT `codiceLibro` FOREIGN KEY (`codiceLibro`) REFERENCES `libro` (`Codice`)
